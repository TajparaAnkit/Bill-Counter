      ...
      <div className="bg-white rounded-2xl w-full max-w-lg overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-200">
        ...
        <div className="flex justify-between items-center bg-gradient-to-r from-green-500 to-green-600 p-6 text-white">
          <div>
            ...
            <p className="text-xs text-green-100 mt-1">Import multiple items instantly</p>
          </div>
          <button 
            onClick={onClose}
...
{`[
  { "name": "Crochet Hat", "price": 450 },
  { "name": "Mini Amigurumi Toy", "price": 299 }
]`}
                  </pre>
                </div>
              </div>
              ...
              <textarea
                ...
                rows={8}
                className="w-full p-3 border border-gray-200 rounded-xl font-mono text-xs focus:outline-none focus:ring-2 focus:ring-green-500 bg-gray-50 focus:bg-white transition-all"
              />
